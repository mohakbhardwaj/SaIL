...
MODEL_FILE_3="../SaIL/learners/trained_models/xy/forest/"
MODEL_FILE_4="../SaIL/learners/trained_models/xy/gaps_and_forest/iter_7_features_17_num_train_envs_200_num_valid_envs_70"
MODEL_FILE_5="../SaIL/learners/trained_models/xy/mazes/validation/"
MODEL_FILE_6="../SaIL/learners/trained_models/xy/multiple_bugtraps/200_70"
MODEL_FILE_7="../SaIL/learners/trained_models/xy/shifting_gaps/iter_5_features_17_num_train_envs_200_num_valid_envs_70"
MODEL_FILE_8="../SaIL/learners/trained_models/xy/single_bugtrap/iter_15_features_7_num_train_envs_200_num_valid_envs_70"
...
RESULTS_FOLDER_5="../SaIL/results/xy/mazes/validation/"
...
python sail_xy_test.py --test_folders ${TEST_FOLDER_7} --test_oracle_folders ${ORACLE_FOLDER_7} --model_files ${MODEL_FILE_7} --result_folders ${RESULTS_FOLDER_7} --num_envs ${NUM_ENVS} --test_file_start_num ${TEST_FILE_START_NUM} --oracle_file_type ${ORACLE_FILE_TYPE}  --visualize 
